...
export declare class AutoComplete implements AfterViewChecked, AfterContentInit, OnDestroy, ControlValueAccessor {
    ...
    get multiContainerClass(): string;
    get panelClass(): {
